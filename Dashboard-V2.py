...
st.sidebar.markdown("Remarks: The SEIRV Model used for the dashboard was referred from A susceptible-exposed-infected-recovered-vaccinated (SEIRV) mathematical model of measles in Madagascar by Alhamami, H.(2019). Meanwhile,for the range of parameters, they were estimated based on Singapore’s pandemic preparedness: An overview of the first wave of covid-19 paper by Tan, J., B. (2021)")
