...
fig_model.update_layout(title='SEIRV Model',xaxis_title='Day',yaxis_title='Population',title_x=0.5,font=dict(family="Times New Roman",size=20,color="Black"),width=700, height=700)
