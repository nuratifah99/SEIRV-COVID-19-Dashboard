...
E0=st.sidebar.slider("Initial Exposed Population,  E0: ".translate(subscript), min_value=int(0.1*N), max_value=int(0.5*N), step=1)
...
lamda=st.sidebar.slider("Recruitment rate of susceptible, λ: ", min_value=int(0.1*S0), max_value=int(0.5*S0), step=1)
